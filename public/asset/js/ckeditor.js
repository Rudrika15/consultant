...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "K24B", version: "4.14.0", revision: "8a12b04171", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, h = 0, k = function () { h = 1 }; return function (g, l, v) {
                    var e = d(this)[g]; g = a; var x = h; a = h = 0; if (e) {
                        var t = e.listeners; if (t.length) for (var t = t.slice(0), z, G = 0; G < t.length; G++) {
                            if (e.errorProof) try {
                                z =
                                t[G].call(this, v, l, b, k)
                            } catch (u) { } else z = t[G].call(this, v, l, b, k); !1 === z ? h = 1 : "undefined" != typeof z && (l = z); if (a || h) break
                        }
    ...
    (function () {
        function a(a, b, e) { this._minInterval = a; this._context = e; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(b, e || {}); var c = this; this.input = function () { function a() { c._lastOutput = (new Date).getTime(); c._scheduledTimer = 0; c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var x = (new Date).getTime() - c._lastOutput; x < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - x) : a() } } } function d(x, b, e) {
            ...
            writeCssText: function (a, b) { var e, c = []; for (e in a) c.push(e + ":" + a[e]); b && c.sort(); return c.join("; ") }, objectCompare: function (a, b, e) { var c; if (!a && !b) return !0; if (!a || !b) return !1; for (c in a) if (a[c] != b[c]) return !1; if (!e) for (c in b) if (a[c] != b[c]) return !1; return !0 }, objectKeys: function (a) { return CKEDITOR.tools.object.keys(a) }, convertArrayToObject: function (a, b) { var e = {}; 1 == arguments.length && (b = !0); for (var c = 0, g = a.length; c < g; ++c)e[a[c]] = b; return e }, fixDomain: function () {
                ...
                var e = b & 16711680, c = b & 65535, g = CKEDITOR.env.mac, n = [], d = []; e & CKEDITOR.CTRL && (n.push(g ? "⌘" : a[17]), d.push(g ? a[224] : a[17])); e & CKEDITOR.ALT && (n.push(g ? "⌥" : a[18]), d.push(a[18])); e & CKEDITOR.SHIFT && (n.push(g ?
                    "⇧" : a[16]), d.push(a[16])); c && (a[c] ? (n.push(a[c]), d.push(a[c])) : (n.push(String.fromCharCode(c)), d.push(String.fromCharCode(c)))); return { display: n, aria: d }
                ...
                var b = "", e = a.length, c; for (c = 0; c < e; c += 3) {
                    var g = a.slice(c, c + 3), n = g.length, d = [], l; if (3 > n) for (l = n; 3 > l; l++)g[l] = 0; d[0] = (g[0] & 252) >> 2; d[1] = (g[0] & 3) << 4 | g[1] >> 4; d[2] = (g[1] & 15) << 2 | (g[2] & 192) >> 6; d[3] = g[2] & 63; for (l = 0; 4 > l; l++)b = l <= n ?
                ...
                filter: function (a, b, e) { var c = []; this.forEach(a, function (g, n) { b.call(e, g, n, a) && c.push(g) }); return c }, find: function (a, b, e) { for (var c = a.length, g = 0; g < c;) { if (b.call(e, a[g], g, a)) return a[g]; g++ } },
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var e, d = c.startContainer; e = c.endContainer; var f = c.startOffset, x = c.endOffset, h, g = this.guard, m = this.type, B = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (e) { var d, f; d = e && e.type != CKEDITOR.NODE_ELEMENT && (f = e.getParent()) && c(f); d = a ? d : d || c(e); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (e) { b(e) ? e = 1 : (e.type == CKEDITOR.NODE_TEXT && (e = e.getParent()), e = e.$.offsetWidth <= c); return !!(a ^ e) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                ...
                function (a) { return function (b) { b = h(b) || k(b) || g(b); return !!(a ^ b) } }; var v = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, e = b.getChildCount(); c < e; ++c)if (!v(b.getChild(c))) return !!a; return !a } }; var e = CKEDITOR.dom.walker.empty(), x = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        v(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(x) && e(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, f) {
            function h(a, b, c, e) { var D = c ? a.getPrevious() : a.getNext(); if (e && k) return D; l || e ? b.append(a.clone(!0, f), c) : (a.remove(), v && b.append(a, c)); return D } function n() { var a, b, c, e = Math.min(S.length, p.length); for (a = 0; a < e; a++)if (b = S[a], c = p[a], !b.equals(c)) return a; return a - 1 } function g() {
                var b = N - 1, c = C && F && !m.equals(B); b < O - 1 || b < q - 1 || c ? (c ? a.moveToPosition(B,
            ...
            } a.optimizeBookmark(); var k = 0 === b, v = 1 == b, l = 2 == b; b = l || v; var m = a.startContainer, B = a.endContainer,
                K = a.startOffset, A = a.endOffset, M, r, C, F, w, T; if (l && B.type == CKEDITOR.NODE_TEXT && (m.equals(B) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(B))) c.append(a.document.createText(B.substring(K, A))); else {
                    B.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : B = B.split(A) : 0 < B.getChildCount() ? A >= B.getChildCount() ? (B = B.getChild(A - 1), r = !0) : B = B.getChild(A) : F = r = !0; m.type == CKEDITOR.NODE_TEXT ? l ? w = !0 : m.split(K) : 0 < m.getChildCount() ? 0 === K ? (m = m.getChild(K), M = !0) : m = m.getChild(K - 1) : C = M = !0; for (var S = m.getParents(), p = B.getParents(), N = n(),
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && v(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var h = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), v = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    ...
                    }; if (this.collapsed) break; var n = this.getCommonAncestor(), g = this.root, k, v, l, m, B, K = !1, A, M; A = this.startContainer; var r = this.startOffset; A.type == CKEDITOR.NODE_TEXT ? (r && (A = !CKEDITOR.tools.trim(A.substring(0, r)).length && A, K = !!A), A && ((m = A.getPrevious()) || (l = A.getParent()))) : (r && (m = A.getChild(r - 1) || A.getLast()), m || (l = A));
                        for (l = c(l); l || m;) {
                            if (l && !m) { !B && l.equals(n) && (B = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break; K && "inline" == l.getComputedStyle("display") || (K = !1, B ? k = l : this.setStartBefore(l)); m = l.getPrevious() } for (; m;)if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
                                if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), d.test(M) && (m = null), A = /[\s\ufeff]$/.test(M); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                    M = m.getText();
                                    if (d.test(M)) m = null; else for (var r = m.$.getElementsByTagName("*"), C = 0, F; F = r[C++];)if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) { m = null; break } m && (A = !!M.length)
                                } else m = null; A && (K ? B ? k = l : l && this.setStartBefore(l) : K = !0); if (m) { A = m.getPrevious(); if (!l && !A) { l = m; m = null; break } m = A } else l = null
                            } l && (l = c(l.getParent()))
                        } A = this.endContainer; r = this.endOffset; l = m = null; B = K = !1; A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(r)).length ? K = !0 : (K = !A.getLength(), r == A.getLength() ? (m = A.getNext()) || (l = A.getParent()) :
                            h(A, r) && (l = A.getParent())) : (m = A.getChild(r)) || (l = A); for (; l || m;) {
                                if (l && !m) { !B && l.equals(n) && (B = !0); if (f ? l.isBlockBoundary() : !g.contains(l)) break; K && "inline" == l.getComputedStyle("display") || (K = !1, B ? v = l : l && this.setEndAfter(l)); m = l.getNext() } for (; m;) {
                                    A = !1; if (m.type == CKEDITOR.NODE_TEXT) M = m.getText(), h(m, 0) || (m = null), A = /^[\s\ufeff]/.test(M); else if (m.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            M = m.getText(); if (d.test(M)) m =
                                                null; else for (r = m.$.getElementsByTagName("*"), C = 0; F = r[C++];)if (!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]) { m = null; break } m && (A = !!M.length)
                                        } else m = null
                                    } else A = 1; A && K && (B ? v = l : this.setEndAfter(l)); if (m) { A = m.getNext(); if (!l && !A) { l = m; m = null; break } m = A } else l = null
                                } l && (l = c(l.getParent()))
                            } k && v && (n = k.contains(v) ? v : k, this.setStartBefore(n), this.setEndAfter(n)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: l = new CKEDITOR.dom.range(this.root); g = this.root; l.setStartAt(g,
                                CKEDITOR.POSITION_AFTER_START); l.setEnd(this.startContainer, this.startOffset); l = new CKEDITOR.dom.walker(l); var w, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), p = null, N = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (p) { if (p.equals(a)) { p = null; return } } else p = a; else if (p) return; var b = S(a); b || (w = a); return b }, f = function (a) { var b = N(a); !b && a.is && a.is("br") && (T = a); return b }; l.guard = N; l = l.lastBackward(); w = w || g; this.setStartAt(w,
                                    !w.is("br") && (!l && this.checkStartOfBlock() || l && w.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone(); l = new CKEDITOR.dom.walker(l); var O = CKEDITOR.dom.walker.whitespaces(), q = CKEDITOR.dom.walker.bookmark(); l.evaluator = function (a) { return !O(a) && !q(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone(); l.collapse(); l.setEndAt(g, CKEDITOR.POSITION_BEFORE_END); l = new CKEDITOR.dom.walker(l); l.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : N; w = p = T = null; l = l.lastForward(); w = w || g; this.setEndAt(w, !l && this.checkEndOfBlock() || l && w.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); T && this.setEndAfter(T)
                }
                ...
                var d = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, f = c && c.skipBogus; if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT; var h = this.clone(), n = this.startContainer, g = this.endContainer, k = this.startOffset, l = this.endOffset,
                        v = c = 1; n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? h.setStartAfter(n) : (h.setStartBefore(n), c = 0) : h.setStartBefore(n)); g && g.type == CKEDITOR.NODE_TEXT && (l ? l >= g.getLength() ? h.setEndAfter(g) : (h.setEndAfter(g), v = 0) : h.setEndBefore(g)); var h = new CKEDITOR.dom.walker(h), m = CKEDITOR.dom.walker.bookmark(), B = CKEDITOR.dom.walker.bogus(); h.evaluator = function (b) { return b.type == (a == CKEDITOR.SHRINK_ELEMENT ? CKEDITOR.NODE_ELEMENT : CKEDITOR.NODE_TEXT) }; var K; h.guard = function (b, c) {
                            if (f && B(b) || m(b)) return !0; if (a == CKEDITOR.SHRINK_ELEMENT &&
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, f, h) {
            ...
            g = function (a) { return h(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, t, z, G; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var u = this.range.clone(); k = u.startPath(); var n = u.endPath(), L = !u.collapsed && c(u, k.block), y = !u.collapsed && c(u, n.block, 1); u.shrink(CKEDITOR.SHRINK_ELEMENT, !0); L && u.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END); y && u.setEndAt(n.block, CKEDITOR.POSITION_AFTER_START); k = u.endContainer.hasAscendant("pre", !0) || u.startContainer.hasAscendant("pre", !0); u.enlarge(this.forceBrBreak && !k || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                        u.collapsed || (k = new CKEDITOR.dom.walker(u.clone()), n = CKEDITOR.dom.walker.bookmark(!0, !0), k.evaluator = n, this._.nextNode = k.next(), k = new CKEDITOR.dom.walker(u.clone()), k.evaluator = n, k = k.previous(), this._.lastNode = k.getNextSourceNode(!0, null, u.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (n = this.range.clone(), n.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), n.checkEndOfBlock() &&
                            (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && u.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = u.document.createText(""), this._.lastNode.insertAfter(k)), u = null); this._.started = 1; k = u
                    } n = this._.nextNode; u = this._.lastNode; for (this._.nextNode = null; n;) {
                        var L = 0, y = n.hasAscendant("pre"), H = n.type != CKEDITOR.NODE_ELEMENT, I = 0; if (H) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (H = 0); else {
                            var m = n.getName();
                            if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) { d = n; b(this, a, d); break } else if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == m) H = 1; else if (!k && !n.getChildCount() && "hr" != m) { d = n; t = n.equals(u); break } k && (k.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), "br" != m && (this._.nextNode = n)); L = 1 } else { if (n.getFirst()) { k || (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START)); n = n.getFirst(); continue } H = 1 }
                        } H && !k && (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                        t = (!L || H) && n.equals(u); if (k && !L) for (; !n.getNext(g) && !t;) { m = n.getParent(); if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { L = 1; H = 0; t || m.equals(u); k.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); break } n = m; H = 1; t = n.equals(u); I = 1 } H && k.setEndAt(n, CKEDITOR.POSITION_AFTER_END); n = this._getNextSourceNode(n, I, u); if ((t = !n) || L && k) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, m; a = []; for (f in b) {
                m = b[f]; m = "boolean" == typeof m ? {} : "function" == typeof m ? { match: m } : C(m); "$" != f.charAt(0) && (m.elements = f); c && (m.featureName = c.toLowerCase()); var q = m; q.elements = k(q.elements, /\s+/) || null; q.propertiesOnly = q.propertiesOnly || !0 === q.elements; var F = /\s*,\s*/, r = void 0; for (r in T) {
                    q[r] = k(q[r], F) || null; var h = q, p = S[r], n = k(q[S[r]], F), g = q[r], w = [], E = !0, N = void 0; n ? E = !1 : n = {}; for (N in g) "!" == N.charAt(0) && (N = N.slice(1), w.push(N), n[N] = !0, E = !1); for (; N = w.pop();)g[N] =
                        g["!" + N], delete g["!" + N]; h[p] = (E ? !1 : n) || null
                } q.match = q.match || null; d.push(m); a.push(m)
            } b = e.elements; e = e.generic; var B; c = 0; for (d = a.length; c < d; ++c) {
                f = C(a[c]); m = !0 === f.classes || !0 === f.styles || !0 === f.attributes; q = f; r = p = F = void 0; for (F in T) q[F] = L(q[F]); h = !0; for (r in S) { F = S[r]; p = q[F]; n = []; g = void 0; for (g in p) -1 < g.indexOf("*") ? n.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : n.push(g); p = n; p.length && (q[F] = p, h = !1) } q.nothingRequired = h; q.noProperties = !(q.attributes || q.classes || q.styles); if (!0 === f.elements ||
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function h(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = F(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function g(a, b) {
            ...
            } function e(a) { var b, c, d, e, f = {}, m = 1; for (a = F(a); b = a.match(p);)(c = b[2]) ? (d = x(c, "styles"), e = x(c, "attrs"), c = x(c, "classes")) : d = e = c = null, f["$" + m++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f } function x(a, b) { var c = a.match(N[b]); return c ? F(c[1]) : null } function t(a) {
                ...
                var F = 0, r; f.toHtml && (b.name = b.name.replace(O, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { r = a.elementCallbacks; for (var p = 0, h = r.length, g; p < h; ++p)if (g = r[p](b)) { r = g; break a } r = void 0 } if (r) return r } if (f.doTransform && (r = a._.transformations[b.name])) { t(b); for (p = 0; p < r.length; ++p)m(a, b, r[p]); u(b) } if (f.doFilter) {
                    a: {
                    ...
                    } if (!a || !a.valid) return e.push(b), 1; C = a.validAttributes; var N = a.validStyles;
                    r = a.validClasses; var p = b.attributes, E = b.styles, h = b.classes; g = b.classBackup; var B = b.styleBackup, A, K, l = [], k = [], M = /^data-cke-/; w = !1; delete p.style; delete p["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (A in p) C[A] || (M.test(A) ? A == (K = A.replace(/^data-cke-saved-/, "")) || C[K] || (delete p[A], w = !0) : (delete p[A], w = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (A in E) a.allStyles || N[A] ? l.push(A + ":" + E[A]) : w = !0; l.length && (p.style = l.sort().join("; ")) } else B && (p.style = B); if (!a.allClasses ||
                        a.hadInvalidClass) { for (A = 0; A < h.length; ++A)(a.allClasses || r[h[A]]) && k.push(h[A]); k.length && (p["class"] = k.sort().join(" ")); g && k.length < g.split(/\s+/).length && (w = !0) } else g && (p["class"] = g); w && (F = 1); if (!f.skipFinalValidation && !n(b)) return e.push(b), 1
                } f.toHtml && (b.name = b.name.replace(q, "cke:$1")); return F
            } function G(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function u(a) {
            ...
            } function n(a) { switch (a.name) { case "a": if (!(a.children.length || a.attributes.name || a.attributes.id)) return !1; break; case "img": if (!a.attributes.src) return !1 }return !0 } function L(a) { if (!a) return !1; if (!0 === a) return !0; var b = G(a); return function (c) { return c in a || b && c.match(b) } } function y() { return new CKEDITOR.htmlParser.element("br") } function H(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && ("br" ==
                    a.name || r.$block[a.name])
            } function I(a, b, c) {
                var d = a.name; if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = y(), b.insertBefore(a)), a.next && !H(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren(); else {
                ...
                allow: function (b, c, d) {
                    ...
                    if (this.disabled) return !1; var e = this, f = [], m = this.editor && this.editor.config.protectedSource, q, p = !1, h = { doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b };
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (q = z(e, a, f, h), q & 1) p = !0; else if (q & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var r, F, n; if (m) for (F = 0; F < m.length; ++F)if ((n = d.match(m[F])) && n[0].length == d.length) {
                                    c =
                                    !0; break a
                    ...
                    }, null, !0); f.length && (p = !0); var F; a = []; d = w[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var g; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? I(c, d, a) : c.remove(); for (; F = a.pop();)if (c = F.el, c.parent) switch (g = r[c.parent.name] || r.span, F.check) {
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b)d.push(K(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, e; for (e = 0; e < a.length; ++e) {
                            b = a[e]; var f = void 0, m = void 0, q = void 0, p = void 0, r = void 0, h = void 0; c = []; for (m = 0; m < b.length; ++m)q = b[m], "string" == typeof q ? (q = q.split(/\s*:\s*/), p = q[0], r = null, h = q[1]) : (p = q.check, r = q.left, h = q.right), f || (f = q, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), r instanceof CKEDITOR.style && (r = A(r)), c.push({ check: p == f ? null : p, left: r, right: "string" == typeof h ? M(h) : h }); b = f; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                    ...
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var f, q; if ("string" == typeof a) {
                        ...
                        f.classes = d = d ? d.split(/\s*,\s*/) : []; f.styles = v(p); f.attributes = v(f.attributes); f.children = []; d.length && (f.attributes["class"] = d.join(" ")); p && (f.attributes.style = CKEDITOR.tools.writeCssText(f.styles))
                    } else f = a.getDefinition(), p = f.styles, d = f.attributes || {}, p && !CKEDITOR.tools.isEmpty(p) ? (p = C(p), d.style = CKEDITOR.tools.writeCssText(p, !0)) : p = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: p, children: [] }; var p = CKEDITOR.tools.clone(f), r = [], h; if (!1 !== b && (h = this._.transformations[f.name])) {
                        for (d =
                            0; d < h.length; ++d)m(this, f, h[d]); u(f)
                    } z(this, p, r, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < r.length ? c = !1 : ((b = f.attributes["class"]) && (f.attributes["class"] = f.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(f.attributes, p.attributes, !0), b && (f.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[q] = c); return c
                }, getAllowedEnterMode: function () {
                    var a = ["p", "div", "br"], b = { p: CKEDITOR.ENTER_P, div: CKEDITOR.ENTER_DIV, br: CKEDITOR.ENTER_BR };
                    return function (c, d) { var f = a.slice(), e; if (this.check(w[c])) return c; for (d || (f = f.reverse()); e = f.pop();)if (this.check(e)) return b[e]; return CKEDITOR.ENTER_BR }
            ...
            }; var T = { styles: 1, attributes: 1, classes: 1 }, S = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, O = /^cke:(object|embed|param)$/, q = /^(object|embed|param)$/, E; E = CKEDITOR.filter.transformationsTools = {
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, f, h) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var g = b.length, l = [], v = [], e = function (a) { c && (k ? c.call(f, a) : c.call(f, l, v)) }; if (0 === g) e(!0); else {
                    var x = function (a, b) { (b ? l : v).push(a); 0 >= --g && (h && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), e(b)) }, t = function (b, c) { a[b] = 1; var f = d[b]; delete d[b]; for (var e = 0; e < f.length; e++)f[e](b, c) }, z = function (b) {
                        if (a[b]) x(b, !0); else {
            ...
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(h, a); var b = [], e; for (e in a) {
                        var g = a[e], t = g && g.requires; if (!d[e]) { if (g.icons) for (var z = g.icons.split(","), G = z.length; G--;)CKEDITOR.skin.addIcon(z[G], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + z[G] + ".png"); g.isSupportedEnvironment = g.isSupportedEnvironment || function () { return !0 }; d[e] = 1 } if (t) for (t.split && (t =
    ...
    (function () {
        function a(a, e, f) {
        ...
        } function l(a) { CKEDITOR.skin.loadPart("editor", function () { v(a) }) } function v(a) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), e = b(c.extraPlugins), f = b(c.removePlugins); if (e) var h = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""), d = d + ("," + e); if (f) var g = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g,
                ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","), function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var m in b) {
                        var h = b[m], k = h.lang, B = null, p = h.requires, N; CKEDITOR.tools.isArray(p) && (p = p.join(",")); if (p && (N = p.match(g))) for (; p = N.pop();)CKEDITOR.error("editor-plugin-required", { plugin: p.replace(",", ""), requiredBy: m }); k && !a.lang[m] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? B = a.langCode : (B = a.langCode.replace(/-.*/, ""), B =
                            B != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, B) ? B : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[B] ? (a.lang[m] = h.langEntries[B], B = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + B + ".js"))); e.push(B); d.push(h)
                    } CKEDITOR.scriptLoader.load(f, function () {
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)for (var m = 0; m < d.length; m++) { var p = d[m]; 0 === f && e[m] && p.lang && p.langEntries && (a.lang[p.name] = p.langEntries[e[m]]); if (p[b[f]]) p[b[f]](a) } a.fireOnce("pluginsLoaded");
                            c.keystrokes && a.setKeystroke(a.config.keystrokes); for (m = 0; m < a.config.blockedKeystrokes.length; m++)a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[m]] = 1; a.status = "loaded"; a.fireOnce("loaded"); CKEDITOR.fire("instanceLoaded", null, a)
                        }
                    })
                })
            ...
            function c(a) {
                ...
                var l = a[k], r = l.startContainer.getAscendant("tr", !0); c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), h && h.equals(r) || (h =
                    r, g = r.clone(), f.append(g)), g.append(d(l))) : e.append(l.cloneContents())
            } return f ? e : b.getHtmlFromRange(a[0])
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var G = 0, u = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (h, k, g) {
                function l(a) { var b; if (0 < n.length) for (var c = 0; c < n.length; c++) { var d = n[c], e = d.name, f = CKEDITOR.dtd[e], h = y.name && CKEDITOR.dtd[y.name]; h && !h[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == y.name && (x(y, y.parent, 1), c--) : (b || (v(), b = 1), d = d.clone(), d.parent = y, y = d, n.splice(c, 1), c--) } } function v() { for (; L.length;)x(L.shift(), y) } function e(a) {
                ...
                } function x(b, c, d) { c = c || y || u; var f = y; void 0 === b.previous && (t(c, b) && (y = c, G.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (I = !1), "textarea" == b.name && (H = !1)); b.returnPoint ? (y = b.returnPoint, delete b.returnPoint) : y = d ? c : f } function t(a, b) {
                    ...
                    if (a(f)) n.push(f); else {
                        if ("pre" == e) I = !0; else { if ("br" == e && I) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (H = !0) } if ("br" == e) L.push(f); else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || g[e]);)if (y.isOptionalClose) G.onTagClose(h); else if (e in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || x(h = new CKEDITOR.htmlParser.element("li"), y), !f.returnPoint && (f.returnPoint = y), y = h; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, h)) G.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (h in d && !z(e, h)) !f.returnPoint && (f.returnPoint = y), y = y.parent; else if (h in CKEDITOR.dtd.$inline && n.unshift(y), y.parent) x(y, y.parent, 1); else { f.isOrphan = 1; break } l(e); v(); f.parent = y; f.isEmpty ? x(f) : y = f
                        }
                    }
                }; G.onTagClose = function (a) {
                    for (var b = n.length - 1; 0 <= b; b--)if (a == n[b].name) { n.splice(b, 1); return } for (var c = [], d = [], e = y; e != u && e.name != a;)e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent; if (e != u) {
                        for (b = 0; b < c.length; b++) { var f = c[b]; x(f, f.parent) } y =
                            e; e._.isBlockLike && v(); x(e, e.parent); e == y && (y = y.parent); n = n.concat(d)
                    } "body" == a && (g = !1)
                }; G.onText = function (a) { if (!(y._.hasInlineStarted && !L.length || I || H) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name, e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!H && !e["#"] && b in d) G.onTagOpen(f[b] || ""), G.onText(a); else { v(); l(); I || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (t(y, a)) this.onTagOpen(g, {}, 0, 1); y.add(a) } }; G.onCDATA =
                    function (a) { y.add(new CKEDITOR.htmlParser.cdata(a)) }; G.onComment = function (a) { v(); l(); y.add(new CKEDITOR.htmlParser.comment(a)) }; G.parse(h); for (v(); y != u;)x(y, y.parent, 1); e(u); return u
        ...
        function a() { this.rules = [] } function d(b, c, d, h) { var k, g; for (k in c) (g = b[k]) || (g = b[k] = new a), g.add(c[k], d, h) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var h = [this.findIndex(c), 0], k = 0, g = a.length; k < g; k++)h.push({ value: a[k], priority: c, options: d }); this.rules.splice.apply(this.rules, h) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, h = Array.prototype.slice.call(arguments, 1), k = this.rules, g = k.length, l, v, e, x; for (x = 0; x < g; x++)if (d && (l = c.type, v = c.name), e = k[x], !(a.nonEditable && !e.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            function e(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function p(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var q = [], p = b(f), m, F; if (p) for (r(p, 1) && q.push(p); p;)h(p) && (m = c(p)) && r(m) && ((F = c(m)) && !h(F) ? q.push(m) : (e(g).insertAfter(m), m.remove())), p = p.previous; for (p = 0; p < q.length; p++)q[p].remove(); if (q = !a || !1 !== ("function" == typeof d ? d(f) : d)) g || CKEDITOR.env.needsBrFiller ||
            ...
            } var F = { elements: {} }, g = "html" == d, w = CKEDITOR.tools.extend({}, m), C; for (C in w) "#" in H[C] || delete w[C]; for (C in w) F.elements[C] = p(g, a.config.fillEmptyBlocks); F.root = p(g, !1); F.elements.br = function (a) {
                return function (b) {
            ...
            return a.replace(r,
                function (a, b, c) { return "\x3c" + b + c.replace(C, function (a, b) { return F.test(b) && -1 == c.indexOf("data-cke-saved-" + b) ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a }) + "\x3e" })
        } function e(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(S, function (a, b) { return decodeURIComponent(b) }) } function t(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + y + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function G(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function u(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                ...
                }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { e[e.id] = decodeURIComponent(b); return "{cke_protected_" + e.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) { return "\x3c" + c + d + "\x3e" + G(z(e), b) + "\x3c/" + c + "\x3e" })
            ...
            f, m = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = f = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(B); c.addRules(K, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); f.addRules(A); f.addRules(M, { applyToAll: !0 }); f.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, f, c = n(c), c = u(c, b), c = e(c, T), c = v(c), c = e(c, w), c = c.replace(p, "$1cke:$2"), c = c.replace(O, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                ...
                a = a.data; var b = a.dataValue,
                    c = new CKEDITOR.htmlParser.basicWriter; b.writeChildrenHtml(c); b = c.getHtml(!0); a.dataValue = t(b)
                ...
                a.data.filter.applyTo(a.data.dataValue,
                    !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = m.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = z(c); c = G(c, b); a.data.dataValue = c }, null, null, 15)
        ...
        }; var L = /(?:&nbsp;|\xa0)$/, y = "{cke_protected}", H = CKEDITOR.dtd, I = "caption colgroup col thead tfoot tbody".split(" "), m = CKEDITOR.tools.extend({}, H.$blockLimit,
            H.$block), B = { elements: { input: g, textarea: g } }, K = { attributeNames: [[/^on/, "data-cke-pa-on"], [/^srcdoc/, "data-cke-pa-srcdoc"], [/^data-cke-expando$/, ""]], elements: { iframe: function (a) { if (a.attributes && a.attributes.src) { var b = a.attributes.src.toLowerCase().replace(/[^a-z]/gi, ""); if (0 === b.indexOf("javascript") || 0 === b.indexOf("data")) a.attributes["data-cke-pa-src"] = a.attributes.src, delete a.attributes.src } } } }, A = {
                elements: {
                    embed: function (a) {
            ...
            }); var r = /<(a|area|img|input|source)\b([^>]*)>/gi, C = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i, w = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, S = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, O = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
    ...
    (function () {
        ...
        CKEDITOR.appendTo = function (b, d, h) { return a(b, d, h, CKEDITOR.ELEMENT_MODE_APPENDTO) }; CKEDITOR.replaceAll = function () { for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) { var d = null, k = a[b]; if (k.name || k.id) { if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(k.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](k, d))) continue; this.replace(k, d) } } }; CKEDITOR.editor.prototype.addMode = function (a, b) {
            ...
            var g = this.container, l = this.ui.space("contents"), v = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement; k = k ? this.container.getFirst(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : g; k.setSize("width", a, !0); v && (v.style.width = "1%");
            var e = (k.$.offsetHeight || 0) - (l.$.clientHeight || 0), g = Math.max(b - (d ? 0 : e), 0); b = d ? b + e : b; l.setStyle("height", g + "px"); v && (v.style.width = "100%"); this.fire("resize", { outerHeight: b, contentsHeight: g, outerWidth: a || k.getSize("width") })
    ...
    (function () {
        ...
        function b(a) { var b = a.data.getTarget(); b.is("input") && (b = b.getAttribute("type"), "submit" != b && "reset" != b || a.data.preventDefault()) } function c(a) { return x(a) && t(a) } function f(a, b) { return function (c) { var d = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget; (d = d && d.nodeType == CKEDITOR.NODE_ELEMENT ? new CKEDITOR.dom.element(d) : null) && (b.equals(d) || b.contains(d)) || a.call(this, c) } } function h(a) {
            ...
            n, L, y, H, I; CKEDITOR.editable = CKEDITOR.tools.createClass({
                base: CKEDITOR.dom.element, $: function (a, b) { this.base(b.$ || b); this.editor = a; this.status = "unloaded"; this.hasFocus = !1; this.setup() }, proto: {
                    ...
                    }, insertHtml: function (a, b, c) { var d = this.editor; d.focus(); d.fire("saveSnapshot"); c || (c = d.getSelection().getRanges()[0]); n(this, b || "html", a, c); c.select(); v(this); this.editor.fire("afterInsertHtml", {}) }, insertHtmlIntoRange: function (a, b, c) { n(this, c || "html", a, b); this.editor.fire("afterInsertHtml", { intoRange: b }) }, insertElement: function (a, b) {
                        var d =
        ...
        x = CKEDITOR.dom.walker.whitespaces(!0); t = CKEDITOR.dom.walker.bookmark(!1, !0); z = CKEDITOR.dom.walker.empty(); G = CKEDITOR.dom.walker.bogus(); u = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; n = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                var e, f, r, g, h = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = F[k.getName()], C = 0, w = c.getChildren(), l = w.count(), n = -1, A = -1, v = 0, T = e.contains(F.$list); C <
                ...
                var e = [],
                f = b.getChildren(), r = f.count(), g, h = 0, k = F[c], C = !b.is(F.$inline) || b.is("br"); for (C && e.push(" "); h < r; h++)g = f.getItem(h), a(g) && !g.is(k) ? e = e.concat(d(g, c)) : e.push(g); C && e.push(" "); return e
            } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) { return b && a(b) && (b.is(F.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) } function r(b, c, d, e) {
                var f = b.clone(), g, h; f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && w[g.getName()] &&
            ...
            } function h(b, c) { function d(b, c) { if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is("br")) return b.remove(), 1 } var e = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset - 1); e && d(e, b[b.length - 1]); f && d(f, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1), c.collapse()) } var F = CKEDITOR.dtd, w = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, n = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, v = CKEDITOR.tools.extend({}, F.$inline); delete v.br; return function (p, w, O, q) {
                var E = p.editor, D = !1; "unfiltered_html" == w && (w = "html", D = !0); if (!q.checkReadOnly()) {
                            ...
                            CKEDITOR.POSITION_BEFORE_END); r(D, w.blockLimit, z, y); u && (D.setEndBefore(u), D.collapse(), u.remove()); u = D.startPath(); if (x = u.contains(f, !1, 1)) V = D.splitElement(x), w.inlineStylesRoot = x, w.inlineStylesPeak = u.lastElement; u = D.createBookmark(); J && (l(x), l(V)); (x = u.startNode.getPrevious(c)) && a(x) && f(x) && t.push(x); (x = u.startNode.getNext(c)) && a(x) && f(x) && t.push(x); for (x = u.startNode; (x = x.getParent()) && f(x);)t.push(x); D.moveToBookmark(u); E.enterMode === CKEDITOR.ENTER_DIV && "" === E.getData(!0) && ((E = p.getFirst()) && E.remove(),
                                q.setStartAt(p, CKEDITOR.POSITION_AFTER_START), q.collapse(!0)); if (p = O) {
                                    p = w.range; if ("text" == w.type && w.inlineStylesRoot) { q = w.inlineStylesPeak; E = q.getDocument().createText("{cke-peak}"); for (V = w.inlineStylesRoot.getParent(); !q.equals(V);)E = E.appendTo(q.clone()), q = q.getParent(); O = E.getOuterHtml().split("{cke-peak}").join(O) } q = w.blockLimit.getName(); if (/^\s+|\s+$/.test(O) && "span" in CKEDITOR.dtd[q]) { var H = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; O = H + O + H } O = w.editor.dataProcessor.toHtml(O,
                                        { context: null, fixForBody: !1, protectedWhitespaces: !!H, dontFilter: w.dontFilter, filter: w.editor.activeFilter, enterMode: w.editor.activeEnterMode }); q = p.document.createElement("body"); q.setHtml(O); H && (q.getFirst().remove(), q.getLast().remove()); if ((H = p.startPath().block) && (1 != H.getChildCount() || !H.getBogus())) a: {
                                            var P; if (1 == q.getChildCount() && a(P = q.getFirst()) && P.is(n) && !P.hasAttribute("contenteditable")) {
                                                H = P.getElementsByTag("*"); p = 0; for (V = H.count(); p < V; p++)if (E = H.getItem(p), !E.is(v)) break a; P.moveChildren(P.getParent(1));
                                                P.remove()
                                            }
                                        } w.dataWrapper = q; p = O
                                } if (p) {
                                    P = w.range; p = P.document; q = w.blockLimit; V = 0; var R, H = [], Q, I; O = u = 0; var L, E = P.startContainer; G = w.endPath.elements[0]; var Z, D = G.getPosition(E), t = !!G.getCommonAncestor(E) && D != CKEDITOR.POSITION_IDENTICAL && !(D & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED), E = b(w.dataWrapper, w); for (h(E, P); V < E.length; V++) {
                                        D = E[V]; if (J = D.isLineBreak) J = P, x = q, y = z = void 0, D.hasBlockSibling ? J = 1 : (z = J.startContainer.getAscendant(F.$block, 1)) && z.is({ div: 1, p: 1 }) ? (y = z.getPosition(x), y ==
                                            CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? J = 0 : (x = J.splitElement(z), J.moveToPosition(x, CKEDITOR.POSITION_AFTER_START), J = 1)) : J = 0; if (J) O = 0 < V; else {
                                                J = P.startPath(); !D.isBlock && k(w.editor, J.block, J.blockLimit) && (I = g(w.editor)) && (I = p.createElement(I), I.appendBogus(), P.insertNode(I), CKEDITOR.env.needsBrFiller && (R = I.getBogus()) && R.remove(), P.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END)); if ((J = P.startPath().block) && !J.equals(Q)) { if (R = J.getBogus()) R.remove(), H.push(J); Q = J } D.firstNotAllowed &&
                                                ...
                                                D.lastNotAllowed && V < E.length - 1 && ((L = t ? G : L) && P.setEndAt(L, CKEDITOR.POSITION_AFTER_START), u = 0); P.collapse()
                                            }
                                    } 1 != E.length ? R = !1 : (R = E[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable")); R && (O = !0, J = E[0].node, P.setStartAt(J, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(J, CKEDITOR.POSITION_AFTER_END)); w.dontMoveCaret = O; w.bogusNeededBlocks = H
                                } R = w.range; var Y; L = w.bogusNeededBlocks; for (Z = R.createBookmark(); Q = w.zombies.pop();)Q.getParent() && (I = R.clone(), I.moveToElementEditStart(Q), I.removeEmptyBlocksAtEnd());
        ...
        y = function () {
            ...
            }, bogus: { exclude: function (a) { var b = a.range.getBoundaryNodes(), c = b.startNode, b = b.endNode; !b || !G(b) || c && c.equals(b) || a.range.setEndBefore(b) } },
            tree: {
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
        ...
        } function k() { B = !0; m || (g.call(this), m = CKEDITOR.tools.setTimeout(g, 200, this)) } function g() { m = null; B && (CKEDITOR.tools.setTimeout(h, 0, this), B = !1) } function l(a) { return K(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function v(a) {
        ...
        } function t(a, b) { return b ? a.replace(H, function (a, b) { return b ? " " : "" }) : a.replace(y, "") } function z(a, b) {
        ...
        } var n = "function" != typeof window.getSelection, L = 1, y = CKEDITOR.tools.repeat("​", 7), H = new RegExp(y + "( )?", "g"), I, m, B, K = CKEDITOR.dom.walker.invisible(1), A = function () {
            function a(b) {
                return function (a) {
                    var c =
            ...
            function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                function a() { v = new CKEDITOR.dom.selection(c.getSelection()); v.lock() } function b() { g.removeListener("mouseup", b); l.removeListener("mouseup", b); var a = CKEDITOR.document.$.selection, c = a.createRange(); "None" != a.type && c.parentElement() && c.parentElement().ownerDocument == f.$ && c.select() } function d(a) {
                    var b,
                ...
                } function e(a) { a = a.getRanges()[0]; return a ? (a = a.startContainer.getAscendant(function (a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") }, !0)) && "false" === a.getAttribute("contenteditable") ? a : null : null } var f = c.document, g = CKEDITOR.document, q = c.editable(), r = f.getBody(), l = f.getDocumentElement(), C = q.isInline(),
                    m, v; CKEDITOR.env.gecko && q.attachListener(q, "focus", function (a) { a.removeListener(); 0 !== m && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == q.$ && (a = c.createRange(), a.moveToElementEditStart(q), a.select()) }, null, null, -2); q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                    ...
                    }, null, null, -1); q.attachListener(q, "mousedown", function () { m = 0 }); if (CKEDITOR.env.ie || CKEDITOR.env.gecko || C) n ? q.attachListener(q, "beforedeactivate", a, null, null, -1) : q.attachListener(c, "selectionCheck", a, null, null, -1), q.attachListener(q, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusout" : "blur", function () { var a = v && (v.isFake || 2 > v.getRanges().length); CKEDITOR.env.gecko && !C && a || (c.lockSelection(v), m = 1) }, null, null, -1),
                        q.attachListener(q, "mousedown", function () { m = 0 }); if (CKEDITOR.env.ie && !C) {
                            var t; q.attachListener(q, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (t = c.window.getScrollPosition())) }); q.attachListener(q, "mouseup", function (a) { 2 == a.data.$.button && t && (c.document.$.documentElement.scrollLeft = t.x, c.document.$.documentElement.scrollTop = t.y); t = null }); if ("BackCompat" != f.$.compatMode) {
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var u, z;
                                    l.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (u) { var c = r.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } u.setEndPoint(0 > z.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); u.select() } } function c() { l.removeListener("mousemove", b); g.removeListener("mouseup", c); l.removeListener("mouseup", c); u.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) {
                                            u = r.$.createTextRange(); try { u.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } z =
                                                u.duplicate(); l.on("mousemove", b); g.on("mouseup", c); l.on("mouseup", c)
                                        }
                                    })
                                } if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) l.on("mousedown", function (a) { a.data.getTarget().is("html") && (g.on("mouseup", b), l.on("mouseup", b)) })
                            }
            ...
            }, null, null, -1); b.on("beforeSetMode", function () { x(b.editable()) }, null, null, -1); b.on("getSnapshot", function (a) { a.data && (a.data = t(a.data)) }, b, null, 20); b.on("toDataFormat", function (a) { a.data.dataValue = t(a.data.dataValue) }, null, null, 0)
            ...
            function (a) {
            ...
            }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: t, _createFillingCharSequenceNode: e, FILLING_CHAR_SEQUENCE: y }); CKEDITOR.dom.selection.prototype = {
                getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: n ? function () {
                    ...
                    var a = n ? function () {
                        function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                            ...
                            if (!h) return { container: d, offset: a(f) + (0 < n ? 0 : 1) }; for (; 0 < h;)try { g = f[0 < n ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g } catch (v) { return { container: d, offset: a(f) } } return { container: m, offset: 0 < n ? -h : m.nodeValue.length + h }
                        }; return function () {
                    ...
                    if (this.isLocked) {
                        if (a) var b =
                            this.getSelectedElement(), c = this.getRanges(), e = this.isFake; this.isLocked = 0; this.reset(); a && (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body", 1) && (this.root.editor.plugins.tableselection && d(c) ? f.call(this, c) : e ? this.fake(b) : b && 2 > c.length ? this.selectElement(b) : this.selectRanges(c))
                    }
                }, reset: function () {
                    ...
                    var b = this.root.editor, c = b && b._.hiddenSelectionContainer; this.reset(); if (c) for (var c = this.root, g, h = 0; h < a.length; ++h)g = a[h], g.endContainer.equals(c) && (g.endOffset = Math.min(g.endOffset,
                        c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var p; a: { var l, m; if (1 == a.length && !(m = a[0]).collapsed && (p = m.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(), m.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (p = l), "false" == p.getAttribute("contenteditable"))) break a; p = void 0 } if (p) this.fake(p); else if (b && b.plugins.tableselection &&
                    ...
                    var c =
                        this.root.editor; void 0 === b && a.hasAttribute("aria-label") && (b = a.getAttribute("aria-label")); this.reset(); z(c, b); var d = this._.cache, e = new CKEDITOR.dom.range(this.root); e.setStartBefore(a); e.setEndAfter(a); d.ranges = new CKEDITOR.dom.rangeList(e); d.selectedElement = d.startElement = a; d.type = CKEDITOR.SELECTION_ELEMENT; d.selectedText = d.nativeSel = null; this.isFake = 1; this.rev = L++; c._.fakeSelection = this; this.root.fire("selectionchange")
                }, isHidden: function () {
                    var a = this.getCommonAncestor(); a && a.type == CKEDITOR.NODE_TEXT &&
                        (a = a.getParent()); return !(!a || !a.data("cke-hidden-sel"))
                ...
                }, getCommonAncestor: function () { var a = this.getRanges(); return a.length ? a[0].startContainer.getCommonAncestor(a[a.length - 1].endContainer) : null }, scrollIntoView: function () { this.type != CKEDITOR.SELECTION_NONE && this.getRanges()[0].scrollIntoView() }, removeAllRanges: function () {
                    if (this.getType() !=
                        CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[n ? "empty" : "removeAllRanges"]() } catch (b) { } this.reset() }
                }
            }
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = L(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, m = l || h.includeReadonly; null ==
                    m && (m = c.root.getCustomData("cke_includeReadonly")); var n = CKEDITOR.dtd[g]; n || (k = !0, n = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var v = c.createBookmark(), r = v.startNode, x = v.endNode, t = r, u; if (!l) { var w = c.getCommonAncestor(), l = a(r, w), w = a(x, w); l && (t = l.getNextSourceNode(!0)); w && (x = w) } for (t.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                        l = !1; if (t.equals(x)) t = null, l = !0; else {
                            var z = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null, w = z && "false" == t.getAttribute("contentEditable"), y = z &&
                                t.getAttribute("data-nostyle"); if (z && t.data("cke-bookmark") || t.type === CKEDITOR.NODE_COMMENT) { t = t.getNextSourceNode(!0); continue } if (w && m && CKEDITOR.dtd.$block[z]) for (var A = t, B = f(A), C = void 0, H = B.length, I = 0, A = H && new CKEDITOR.dom.range(A.getDocument()); I < H; ++I) { var C = B[I], K = CKEDITOR.filter.instances[C.data("cke-filter")]; if (K ? K.check(this) : 1) A.selectNodeContents(C), b.call(this, A) } B = z ? !n[z] || y ? 0 : w && !m ? 0 : d(t, x, h, T) : 1; if (B) if (C = t.getParent(), B = h, H = g, I = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[H] && !I || B.parentRule &&
                                    !B.parentRule(C)) l = !0; else { if (u || z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(x) | T) != T || (u = c.clone(), u.setStartBefore(t)), z = t.type, z == CKEDITOR.NODE_TEXT || w || z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) { for (var z = t, M; (l = !z.getNext(F)) && (M = z.getParent(), n[M.getName()]) && d(M, r, h, S);)z = M; u.setEndAfter(z) } } else l = !0; t = t.getNextSourceNode(y || w)
                        } if (l && u && !u.collapsed) {
                            for (var l = L(this, e), w = l.hasAttributes(), y = u.getCommonAncestor(), z = {}, B = {}, C = {}, H = {}, X, W, Y; l && y;) {
                                if (y.getName() == g) {
                                    for (X in h.attributes) !H[X] &&
                                        (Y = y.getAttribute(W)) && (l.getAttribute(X) == Y ? B[X] = 1 : H[X] = 1); for (W in h.styles) !C[W] && (Y = y.getStyle(W)) && (l.getStyle(W) == Y ? z[W] = 1 : C[W] = 1)
                                } y = y.getParent()
                            } for (X in B) l.removeAttribute(X); for (W in z) l.removeStyle(W); w && !l.hasAttributes() && (l = null); l ? (u.extractContents().appendTo(l), u.insertNode(l), G.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), u.extractContents().appendTo(l), u.insertNode(l), G.call(this, l), l.remove(!0)); u = null
                        }
                    } c.moveToBookmark(v);
            ...
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break; n.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break; n.checkElementRemovable(h, !0) && (f = h) } f && m.breakParent(f); e && d.breakParent(e) } a.enlarge(CKEDITOR.ENLARGE_INLINE,
                ...
                } else { var m = c.endNode, n = this; b(); for (f = d; !f.equals(m);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : u(f, I(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function f(a) {
            var b =
        ...
        } function g(a) { var b = a.createBookmark(!0), c = a.createIterator(); c.enforceRealBlocks = !0; this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = L(this, e, d), v(d, f)); a.moveToBookmark(b) } function l(a) {
            var b = a.createBookmark(1), c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) &&
                (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), v(d, e)) : z.call(this, d)); a.moveToBookmark(b)
        } function v(a, b) {
            var c = !b; c && (b = a.getDocument().createElement("div"), a.copyAttributes(b)); var d = b && b.is("pre"), f = a.is("pre"), g = !d && f; if (d && !f) {
                ...
                var c = b, k; (k = c.getPrevious(w)) && k.type == CKEDITOR.NODE_ELEMENT && k.is("pre") && (d = x(k.getHtml(), /\n$/, "") + "\n\n" + x(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" :
        ...
        } function G(a) { for (var b = I(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || u(d, b[f]) } function u(a, b, c) {
            ...
            if (!a.hasAttributes() || b) if (CKEDITOR.dtd.$block[a.getName()]) { var c = a.getPrevious(w), d = a.getNext(w); !c || c.type != CKEDITOR.NODE_TEXT && c.isBlockBoundary({ br: 1 }) || a.append("br", 1); !d || d.type != CKEDITOR.NODE_TEXT && d.isBlockBoundary({ br: 1 }) || a.append("br"); a.remove(!0) } else c = a.getFirst(), d = a.getLast(), a.remove(!0), c && (c.type == CKEDITOR.NODE_ELEMENT && c.mergeSiblings(),
            ...
            return a
        } function H(a, b) { for (var c in a) a[c] = a[c].replace(C, function (a, c) { return b[c] }) } function I(a) { if (a._.overrides) return a._.overrides; var b = a._.overrides = {}, c = a._.definition.overrides; if (c) { CKEDITOR.tools.isArray(c) || (c = [c]); for (var d = 0; d < c.length; d++) { var e = c[d], f, g; "string" == typeof e ? f = e.toLowerCase() : (f = e.element ? e.element.toLowerCase() : a.element, g = e.attributes); e = b[f] || (b[f] = {}); if (g) { var e = e.attributes = e.attributes || [], h; for (h in g) e.push([h.toLowerCase(), g[h]]) } } } return b } function m(a,
            ...
            } var A = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, M = { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 }, r = /\s*(?:;\s*|$)/, C = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0,
                1), w = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                    ...
                    apply: function (a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                        if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection(), 1); if (this.checkApplicable(a.elementPath(),
                            a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 1, a); this._.enterMode = b }
                        ...
                        b, c) { b && b instanceof CKEDITOR.filter && (c = b); if (c && !c.check(this)) return !1; switch (this.type) { case CKEDITOR.STYLE_OBJECT: return !!a.contains(this.element); case CKEDITOR.STYLE_BLOCK: return !!a.blockLimit.getDtd()[this.element] }return !0 }, checkElementMatch: function (a, b) {
                            var c = this._.definition; if (!a || !c.ignoreReadonly && a.isReadOnly()) return !1; var d = a.getName(); if ("string" == typeof this.element ? d == this.element : d in this.element) {
                                ...
                                } if (c._length) { for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? B(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                            } return !1
                    ...
                    var b = a.styles, c = a.attributes && a.attributes.style || "", d = ""; c.length && (c = c.replace(r, ";")); for (var e in b) { var f = b[e], g = (e + ":" + f).replace(r, ";"); "inherit" == f ? d += g : c += g } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0)); return a._ST = c + d
        ...
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var h = null, k = null, g = [], l = b, v; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                g.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (v = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !h && d[v] && (h = l), a[v])) { if (v = !h && "div" == v) { a: { v = l.getChildren(); for (var e = 0, x = v.count(); e < x; e++) { var t = v.getItem(e); if (t.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[t.getName()]) { v = !0; break a } } v = !1 } v = !v } v ? h = l : k = l }
...
*/
    ...
    (function () {
        ...
        CKEDITOR.env.gecko && (d += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;"'); CKEDITOR.env.ie && (g = 'return false;" onmouseup\x3d"CKEDITOR.tools.getMouseButton(event)\x3d\x3dCKEDITOR.MOUSE_BUTTON_LEFT\x26\x26'); var d = d + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" onclick\x3d"' + g + 'CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan id\x3d"{id}_text" class\x3d"cke_combo_text cke_combo_inlinelabel"\x3e{label}\x3c/span\x3e\x3cspan class\x3d"cke_combo_open"\x3e\x3cspan class\x3d"cke_combo_arrow"\x3e' +
            (CKEDITOR.env.hc ? "\x26#9660;" : CKEDITOR.env.air ? "\x26nbsp;" : "") + "\x3c/span\x3e\x3c/span\x3e\x3c/a\x3e\x3c/span\x3e"), m = CKEDITOR.addTemplate("combo", d); CKEDITOR.UI_RICHCOMBO = "richcombo"; CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
                $: function (a) {
                    ...
                    renderHtml: function (a) { var b = []; this.render(a, b); return b.join("") }, render: function (a, b) {
                        function k() { if (this.getState() != CKEDITOR.TRISTATE_ON) { var b = this.modes[a.mode] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED; a.readOnly && !this.readOnly && (b = CKEDITOR.TRISTATE_DISABLED); this.setState(b); this.setValue(""); b != CKEDITOR.TRISTATE_DISABLED && this.refresh && this.refresh() } }
                        var d = CKEDITOR.env, f, e, c = "cke_" + this.id, l = CKEDITOR.tools.addFunction(function (b) { e && (a.unlockSelection(1), e = 0); f.execute(b) }, this), h = this; f = { id: c, combo: this, focus: function () { CKEDITOR.document.getById(c).getChild(1).focus() }, execute: function (b) { var c = h._; if (c.state != CKEDITOR.TRISTATE_DISABLED) if (h.createPanel(a), c.on) c.panel.hide(); else { h.commit(); var d = h.getValue(); d ? c.list.mark(d) : c.list.unmarkAll(); c.panel.showBlock(h.id, new CKEDITOR.dom.element(b), 4) } }, clickFn: l }; this._.listeners.push(a.on("activeFilterChange",
                            k, this)); this._.listeners.push(a.on("mode", k, this)); this._.listeners.push(a.on("selectionChange", k, this)); !this.readOnly && this._.listeners.push(a.on("readOnly", k, this)); var g = CKEDITOR.tools.addFunction(function (a, b) { a = new CKEDITOR.dom.event(a); var c = a.getKeystroke(); switch (c) { case 13: case 32: case 40: CKEDITOR.tools.callFunction(l, b); break; default: f.onkey(f, c) }a.preventDefault() }), n = CKEDITOR.tools.addFunction(function () { f.onfocus && f.onfocus() }); e = 0; f.keyDownFn = g; d = {
                                id: c, name: this.name || this.command,
                                label: this.label, title: this.title, cls: this.className || "", titleJs: d.gecko && !d.hc ? "" : (this.title || "").replace("'", ""), keydownFn: g, focusFn: n, clickFn: l
                            }; m.output(d, b); if (this.onRender) this.onRender(); return f
                    }, createPanel: function (a) {
                        if (!this._.panel) {
                            var b = this._.panelDefinition, d = this._.panelDefinition.block, g = b.parent || CKEDITOR.document.getBody(), f = "cke_combopanel__" + this.name, e = new CKEDITOR.ui.floatPanel(a, g, b), b = e.addListBlock(this.id, d), c = this; e.onShow = function () {
                                this.element.addClass(f); c.setState(CKEDITOR.TRISTATE_ON);
    ...
    CKEDITOR.tools.buildTableMap = function (q, r, B, v, w) { q = q.$.rows; B = B || 0; v = "number" === typeof v ? v : q.length - 1; w = "number" === typeof w ? w : -1; var u = -1, y = []; for (r = r || 0; r <= v; r++) { u++; !y[u] && (y[u] = []); for (var t = -1, z = B; z <= (-1 === w ? q[r].cells.length - 1 : w); z++) { var p = q[r].cells[z]; if (!p) break; for (t++; y[u][t];)t++; for (var A = isNaN(p.colSpan) ? 1 : p.colSpan, p = isNaN(p.rowSpan) ? 1 : p.rowSpan, x = 0; x < p && !(r + x > v); x++) { y[u + x] || (y[u + x] = []); for (var C = 0; C < A; C++)y[u + x][t + C] = q[r].cells[z] } t += A - 1; if (-1 !== w && t >= w) break } } return y }; (function () {
        ...
        }; CKEDITOR.event.implementOn(q.prototype); g.prototype =
        {
            ...
            }, refreshMask: function () { O(this) }, refreshParts: function (a) { N(this, "undefined" !== typeof a ? a : !0) }, removeClass: function (a) { this.element.removeClass(a); this.wrapper.removeClass(g.WRAPPER_CLASS_PREFIX + a) }, removeStyle: function (a) { I(this, a, 0) }, setData: function (a, b) {
                var c = this.data, d = 0; if ("string" == typeof a) c[a] !== b && (c[a] = b, d = 1); else { var e = a; for (a in e) c[a] !== e[a] && (d = 1, c[a] = e[a]) } d && this.dataReady &&
                    (v(this), this.fire("data", c)); return this
