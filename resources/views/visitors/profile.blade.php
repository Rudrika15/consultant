            ...
            <form action="{{route('profile.update')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="image-border mt-4">
                                        <img id="preview-photo" src="{{ asset('profile/' . $profile->photo) }}" class=""
                                            alt="" width="100px" height="100px">
                                        <input type="file" id="photo" name="photo" accept='image/*'
                                            onchange="readURL(this,'#preview-photo')" class="form-control mt-2">
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="fw-bold p-3 " for="firstname" style="color:gray;">First
                                                Name</label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="fw-bold p-3" for="firstname" style="color:gray;">Last
                                                Name</label>
                                            <div class="input-container">
                                                <i class="fa fa-user icon text-center"></i>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="abouttextarea">
                                                {{-- <i class="fa fa-user icon text-center"></i> --}}
                                                <textarea id="about" name="about" class="form-control " cols="20"
                ...
                <div class="col-md-12 mt-5">
                    <div class="card user-avatar mt-md-5">
                        <div class="card-body">
                            <div class="card-text cardtext p-3">
                                <i class="fa fa-envelope profile-user"><span class="ms-3 fw-bold">Contact
                                        Detail</span></i>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="fw-bold p-3" for="contactNo" style="color:gray;">Contact
                                                No</label>
                                            <div class="input-container">
                                                <i class="fa fa-phone icon text-center"></i>
                                                <input type="text" name="contactNo" value="{{Auth::user()->contactNo}}"
                                                    class="form-control input-field">
                                            </div>
                                        </div>
                ...
                <div class="col-md-12 mt-5">
                    <div class="card user-avatar mt-md-5">
                        <div class="card-body">
                            <div class="card-text cardtext p-3">
                                <i class="fa fa-address-card-o profile-user"><span
                                        class="ms-3 fw-bold">Address</span></i>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="address_textarea">
                                                <textarea name="address" id="address" class="form-control" cols="20"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-container">
                                                <i class="fa fa-map-marker icon text-center"></i>
                                                <input type="text" name="map" id="map" value="{{$profile->map}}"
                                                    class="form-control input-field">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="fw-bold p-3" for="email"
                                                    style="color:gray;">Password</label>
                                                <div class="input-container">
                                            ...
                                            <div class="col-md-6">
                                                <label class="fw-bold p-3" for="password_confirmation"
                                                    style="color:gray;">Confirm Password</label>
                                                <div class="input-container">
                                                    <i class="fa fa-lock icon text-center"></i>
                                            ...
                                            <div class="col-md-6 pt-5 mb-3 text-center">
                                                <button type="submit" class="btn  fw-bold"
                                                    id="password-submit">Submit</button>
                                                <a href="{{route('visitor.profile')}}" class="btn fw-bold"
                                                    id="password-reset">Reset</a>
                                            </div>
                                        </div>
                                    </div>
