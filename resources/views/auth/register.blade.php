    ...
    <div class="container mt-5">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="register" data-bs-toggle="tab" data-bs-target="#register" type="button" role="tab" aria-controls="register" aria-selected="true"><h4>Sign Up</h4></button>
            </li>
          </ul>
            ...
            <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="register">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="col-md-6 pt-4">
                            <input id="name" type="text" class="form-control register-form  @error('name') is-invalid @enderror" name="name" placeholder="{{_('First Name')}}" value="{{ old('name') }}" required autocomplete="name" >
                        ...
                        <div class="col-md-6 pt-4">
                            <input id="lastName" type="text" class="form-control register-form  @error('lastName') is-invalid @enderror" name="lastName" placeholder="{{_('Last Name')}}" value="{{ old('lastName') }}" required autocomplete="lastName" >
                        ...
                        <div class="col-md-6 pt-4">
                            <input id="email" type="email" class="form-control register-form @error('email') is-invalid @enderror" name="email" placeholder="{{_('Email')}}" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="col-md-6 pt-4">
                            <select class="form-select register-form" aria-label="Default select example" id="cityId" name="cityId" value="{{ old('cityId') }}" required autocomplete="cityId" >
                        ...
                        <div class="col-md-6 pt-4">
                            <input id="contactNo" type="text" class="form-control register-form @error('contactNo') is-invalid @enderror" name="contactNo" placeholder="{{_('Contact No')}}" value="{{ old('contactNo') }}" required autocomplete="contactNo" >
                        ...
                        <div class="col-md-6 pt-4">
                            <input id="birthdate" type="date" class="form-control register-form  @error('birthdate') is-invalid @enderror" name="birthdate" placeholder="{{_('BirthDate')}}" value="{{ old('birthdate') }}" required autocomplete="birthdate" >
