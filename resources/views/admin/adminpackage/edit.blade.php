...
<div class="card">
    ...
    <div class="card-header"
        ...
        <div class="">
            <a href="{{ route('adminpackage.index') }}" class="btn btn-info btn-sm">BACK</a>
    ...
    <div class="card-body">
        <form class="form-group" id="adminPackageForm" enctype="multipart/form-data" method="post">
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="title" type="text" name="title" value="{{$adminpackage->title}}" class="form-control"
                    placeholder="Title">
                @if ($errors->has('title'))
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="price" type="text" name="price" value="{{$adminpackage->price}}" class="form-control"
                    placeholder="price">
                @if ($errors->has('price'))
            ...
            <div class="form-label-group mt-3">
                ...
                <textarea id="details" rows="10" name="details"
                    class="form-control">{!!$adminpackage->details!!}</textarea>
