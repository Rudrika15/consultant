...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-group" action="{{ route('adminworkshop.update') }}" method="post"
            ...
            <div class="form-label-group mt-3">
                ...
                <textarea id="detail" rows="10" name="detail" class="form-control">{{ $workshop->detail }}</textarea>
            ...
            <div class="form-label-group mt-3">
                <label for="workshopType" class="fw-bold">Workshop Type <sup class="text-danger">*</sup></label>
