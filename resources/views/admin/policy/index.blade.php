...
<div class="card">
    ...
    <div class="card-header"
        ...
        <div class="">
            <a href="{{ route('policy.create') }}" id="add" class="btn btn-info btn-sm">ADD</a>
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#add').hide();
                    $('#back').show();
                    $('#viewDataDiv').html('<strong>Privacy Policy</strong>' + response.policy +'<br><strong>Satus:</strong> ' + response.status);
