...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header"
            ...
            <div class="">
                <h4 class="">Update About</h4>
            </div>
            <div class="">
                <a href="{{ route('about.index') }}" class="btn btnback btn-sm">BACK</a>
        ...
        <div class="card-body">
            <form class="form-group" id="aboutForm" enctype="multipart/form-data" method="post">
                @csrf
                <input type="hidden" id="aboutId" name="aboutId" value="{{$about->id}}">
                <div class="form-label-group mt-3">
                    <label for="about" class="fw-bold">About Details<sup class="text-danger">*</sup></label>
                    <textarea id="about" rows="10" name="about" class="form-control">{!!$about->about!!}</textarea>
                    @if ($errors->has('about'))
