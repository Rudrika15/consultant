...
<div class="card">
    ...
    <div class="card-header"
        ...
        <div class="">
            <a href="{{ route('state.create') }}" id="add" class="btn btn-info btn-sm">ADD</a>
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#add').hide();
                        $('#back').show();
                        $('#viewDataDiv').html('<strong>Category Name:</strong> ' + response
                            .stateName + '<br>' + '<strong>Satus:</strong> ' + response
                            .status);
