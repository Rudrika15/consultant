            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (data) {
                            return '<img src="{{url('/slider')}}/'+ data + '" alt="Logo" style="max-width: 100px; max-height: 100px;">';
                        }
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#add').hide();
                    $('#back').show();
                    $('#viewDataDiv').html('<strong>Type:</strong> ' + response.type + '<br><strong>Photo:</strong><img src="{{url('/slider')}}/' + response.photo + '" width="100px" height="100px" class="ms-3">' + '<br>' + '<strong>Satus:</strong> ' + response.status);
