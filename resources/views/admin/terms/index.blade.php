...
<div class="card">
    ...
    <div class="card-header"
        ...
        <div class="">
            <h4 class="">Terms & Condition</h4>
        </div>
        <div class="">
            <a href="{{ route('terms.create') }}" id="add" class="btn btn-info btn-sm">ADD</a>
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#add').hide();
                    $('#back').show();
                    $('#viewDataDiv').html('<strong>Terms & Condition</strong>' + response.terms +'<br><strong>Satus:</strong> ' + response.status);
