...
<div class="card">
    ...
    <div class="card-header" style="padding: 12px 10px 12px 10px; display: flex; justify-content: space-between; background-color: #345BCB; color:white;">
        ...
        <div class="">
            <h4 class="">Create Certificate</h4>
        </div>
        <div class="">
    ...
    <div class="card-body">
        <form class="form-group" id="certificateForm" name="certificateForm" action="{{route('certificate.store')}}" enctype="multipart/form-data" method="post">
            @csrf
            ...
            <div class="form-label-group mt-3">
                ...
                <img id="preview-photo" src="certificate/default.jpg" name="preview-photo" class="mt-3" width="100px" height="100px">
