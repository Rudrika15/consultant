...
<div class="card">
    ...
    <div class="card-header" style="padding: 12px 10px 12px 10px; display: flex; justify-content: space-between; background-color: #345BCB; color:white;">
        ...
        <div class="">
            <a href="{{ route('package.index') }}" class="btn btnback btn-sm" style="background-color: #002E6E; color:white;">BACK</a>
    ...
    <form class="form-group" id="packageForm" name="packageForm"  enctype="multipart/form-data" >
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="title" type="text" name="title" value="{{$package->title}}" class="form-control" placeholder="title">
                @if ($errors->has('title'))
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="price" type="text" name="price" value="{{$package->price}}" class="form-control" placeholder="price">
                @if ($errors->has('price'))
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="detail" type="text" name="detail" value="{{$package->detail}}" class="form-control" placeholder="detail">
            ...
            <div class="form-label-group mt-3">
                ...
                <input id="validUpTo" type="text" name="validUpTo" value="{{$package->validUpTo}}" class="form-control" placeholder="validUpTo">
